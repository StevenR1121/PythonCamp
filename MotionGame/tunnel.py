...
class death_wall(Entity):# if touched, ends game
...
class normal_wall(Entity):# visal entity
    def __init__(self,scale):
...
class death_tunnel():# use walls to create tunnle
...
class tunnel():# use walls to create tunnle
    def __init__(self,position):
